...
# ตารางจัดกลุ่มอุตสาหกรรมสำรอง (ขยายขอบเขตให้ครอบคลุมและแม่นยำขึ้น)
DEFAULT_SECTORS = {
...
with st.spinner("⏳ กำลังรวบรวมข้อมูลพอร์ตรวมและดึงราคาล่าสุดแบบปลอดภัย..."):
    ...
    if all_holdings:
        ...
        for index, row in df_raw.iterrows():
            ...
            # บังคับดึงข้อมูลให้เจอเซกเตอร์เสมอ
            ...
            # ถ้ายังไม่มีราคา ให้ยิงผ่าน yfinance
        ...
        for index, row in df_raw.iterrows():
            ...
            # 🎯 ตรรกะแปลงหน่วยเงิน: หุ้นไทยทอนเป็น USD เพื่อรวมฐานข้อมูลหลัก
            if broker == "Dime TH":
