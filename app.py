...
def render_dashboard():
    # --- RENDER TOP MARQUEE TICKER (Streamlit Component Isolated) ---
    sample_stocks = [
        ("NU", 18.48, 18.48), 
        ("SVCO", 7.93, 123.38), 
        ("CV", 6.58, 31.60),
    ...
    for sym, price, pnl in sample_stocks:
        ...
        <div class="pill">
            ...
            <span class="{badge_cls}">{sign}{pnl:.2f}%</span>
        </div>
        """
    ...
    <style>
        ...
        .ticker-move {{ display: inline-flex; gap: 14px; white-space: nowrap; animation: marquee 30s linear infinite; }}
    ...
    """
    components.html(marquee_component_code, height=62)
    ...
    with col_left:
        ...
        <div class="dash-card">
            ...
            <div style="color: #f87171; font-size: 0.85rem; margin-top: 6px; font-family: 'JetBrains Mono', monospace; font-weight: 600;">
                {pnl_sign}{symbol}{display_pnl:,.2f} total return
            </div>
            <div style="margin-top: 22px; font-size: 0.82rem; color: #6b7280; font-weight: 700;">Where your money is invested</div>
    ...
    with c_btm_right:
        ...
        with g1: st.markdown('<div class="stock-grid-card"><div style="display:flex; justify-content:space-between; align-items:center;"><span class="stock-symbol">🟢 NU</span><span class="badge-delta-pos">+18.48%</span></div><div class="stock-price">$18.48</div></div>', unsafe_allow_html=True)
